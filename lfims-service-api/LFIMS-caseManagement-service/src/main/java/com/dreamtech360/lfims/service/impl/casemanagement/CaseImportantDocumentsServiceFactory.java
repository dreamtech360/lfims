...
public class CaseImportantDocumentsServiceFactory extends LFIMSServiceFactory<ImportantDocuments>  {
	...
	public CaseImportantDocumentsServiceFactory(){}
	...
	public CaseImportantDocumentsServiceFactory(BundleContext context){
	...
	public LFIMSModelService<ImportantDocuments> lookupService() {
		// TODO Auto-generated method stub
		service=(LFIMSModelService<ImportantDocuments>)context.getService(context.getServiceReference(CaseImportantDocumentsService.class.getName()));
		return service;
	}

	@Override
	public LFIMSModelService<ImportantDocuments> createService() {
		// TODO Auto-generated method stub
		return new CaseImportantDocumentsService(repository);
	}
