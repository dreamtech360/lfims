...
import com.dreamtech360.lfims.model.api.ouradvocatemaster.MutableOurAdvocateMaster;
...
public class MutableOurAdvocateMasterImpl implements MutableOurAdvocateMaster{
	...
	public MutableOurAdvocateMasterImpl(){
	
		}
	
	public MutableOurAdvocateMasterImpl(int id, String advName,String advAddress1, String advAddress2,String cityPin,String contactPhone,String email){
		this.id=id;
