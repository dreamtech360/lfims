...
public class AdvocateMasterImpl implements AdvocateMaster{
	...
	public AdvocateMasterImpl(int id, String advName,String advAddress1, String advAddress2,String cityPin,String contactPhone,String email){
		this.id=id;
