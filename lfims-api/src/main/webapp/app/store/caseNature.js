Ext.define('lfims.store.caseNature', {
	extend: 'Ext.data.Store',
	id:'caseNatureStore',
	model: 'lfims.model.caseMgmtMaintenance.caseNature',
	remoteFilter:true,
	pageSize: itemsPerPage,
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/lfims/webresources/maintenance/casemgmtmaintenance/CN',
		noCache: false,
		reader: {
			type: 'json',
