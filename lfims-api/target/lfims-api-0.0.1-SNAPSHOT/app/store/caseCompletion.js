Ext.define('lfims.store.caseCompletion', {
	extend: 'Ext.data.Store',
	model: 'lfims.model.caseMgmtMaintenance.caseCompletion',
	remoteFilter:true,
	pageSize: itemsPerPage,
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/lfims/webresources/maintenance/casemgmtmaintenance/CC',
		noCache: false,
		reader: {
			type: 'json',
