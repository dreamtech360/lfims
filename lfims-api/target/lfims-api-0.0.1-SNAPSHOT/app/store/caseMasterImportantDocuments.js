Ext.define('lfims.store.caseMasterImportantDocuments', {
	extend: 'Ext.data.Store',
	model: 'lfims.model.caseMaster.caseMasterImportantDocuments',
	remoteFilter:true,
	pageSize: itemsPerPage,
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/lfims/webresources/casemanagement/cases/{caseuuid}/importantDocuments',
		noCache: false,
		reader: {
			type: 'json',
			root: 'case',
