Ext.define('lfims.store.casePosition', {
	extend: 'Ext.data.Store',
	model: 'lfims.model.caseMgmtMaintenance.casePosition',
	remoteFilter:true,
	pageSize: itemsPerPage,
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/lfims/webresources/maintenance/casemgmtmaintenance/CP',
		noCache: false,
		reader: {
			type: 'json',
