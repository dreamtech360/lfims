Ext.define('lfims.store.caseForums', {
	extend: 'Ext.data.Store',
	model: 'lfims.model.caseMgmtMaintenance.caseForums',
	remoteFilter:true,
	pageSize: itemsPerPage,
	proxy: {
		type: 'rest',
		url: 'http://localhost:8080/lfims/webresources/maintenance/casemgmtmaintenance/CF',
		noCache: false,
		reader: {
			type: 'json',
